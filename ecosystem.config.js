...
module.exports = {
  apps: [
    ...
    {
      name: 'cron-fiscal',
      script: './scripts/cron-fiscal-manifestos.js',
      cwd: __dirname,
      instances: 1,
      exec_mode: 'fork',
      autorestart: true,
      ...
      env: {
        NODE_ENV: 'production',
        PORT: 3000,
        CRON_SECRET: 'gestaopostoRede2024@pedra',
        APP_HOST: '192.168.2.68',
      },
      log_date_format: 'YYYY-MM-DD HH:mm:ss',
      error_file: './logs/cron-fiscal-error.log',
      out_file: './logs/cron-fiscal-out.log',
    },
    {
      name: 'cron-extratos',
